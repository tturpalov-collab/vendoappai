...
- **718 автоматов без продаж — это не поломка, а запас**, но запас неоднородный:
  - **298 выходили на связь за последние 30 дней** (85 — за неделю) и не продали
    ничего. Включены, подключены, стоят на точке. По медиане это ~451 тыс. AED/мес
    — почти половина текущего оборота. Самая дешёвая выручка во всём разборе.
...
компании занижен примерно на 4 п.п., а настоящие проблемы тонут в шуме.
Отдельного признака в базе нет — различать приходится по организации.

Пересчёт с этой поправкой:

- базовая линия отказов — **3,3 %** (февраль без soco), а не 7 %;
- март—апрель реально 20,8 %;
- **август без soco — 3,3 %, ровно февральский уровень: сеть восстановлена полностью**;
- потери за март—июль — около **377 тыс. AED**, а не 460 тыс.
